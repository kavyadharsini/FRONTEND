        ...
        <Form onSubmit={this.handleSubmit} className="signup-form">
          ...
          <FormItem>
            {getFieldDecorator("Mobile Number", {
              ...
              { min: 10, max:10, message: "The length should be 12" }]
            })(<Input type="mobile number" placeholder="Mobile number" />)}
          </FormItem>
          <FormItem>
            {getFieldDecorator("Aadhar number", {
              rules: [{ required: true, message: "Please enter your Aadhar NUmber!" },
              { min: 12, max: 12, message: "The length should be 12" }]
          ...
          <FormItem>
            {getFieldDecorator("email", {
              rules: [
                ...
                {
                  required: true,
                  message: "Please enter your your E-mail!"
                }
              ]
